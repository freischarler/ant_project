...
def setup_video():  
    ...
    for _ in range(cant):
        ...
        try:
            ...
            thisVideoFile= '/home/pi/Desktop/video_test.h264'
            camera=PiCamera()
...
class Ui_MainWindow(QMainWindow):
    ...
    def setupUi(self, MainWindow):
        ...
        #hilo0.start()
        print("DESACTIVADO HILO SENSADO POR FALTA DE SENSORES")
    ...
    def grabar_video(self):
        def hilo_grabar_video():
            ...
            try:
                setup_video()
                #p=subprocess.Popen(args=["python3", "video.py"],stdout=subprocess.PIPE,stdin=subprocess.PIPE)
